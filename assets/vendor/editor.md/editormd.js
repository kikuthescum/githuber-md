    ...
    loadQueues: function () {
      ...
      var loadFlowChartOrSequenceDiagram = function () {
        ...
        if (settings.flowChart || settings.sequenceDiagram) {
          editormd.loadScript(
            loadPath + "../../raphael/raphael.min",
            function () {
              if (!settings.flowChart && settings.sequenceDiagram) {
                editormd.loadScript(
                  loadPath + "../../underscore/underscore.min",
                  function () {
                    editormd.loadScript(
                      loadPath +
                        "../../js-sequence-diagrams/sequence-diagram.min",
                      function () {
                        _this.loadedDisplay();
                      }
                    );
                ...
                editormd.loadScript(
                  loadPath + "../../flowchart/flowchart.min",
                  function () {
                    _this.loadedDisplay();
                  }
                );
